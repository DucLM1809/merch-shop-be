  ...
  rules: {
    ...
    'no-restricted-imports': ['error', {
      patterns: [
        ...
        { group: ['*/auth/auth-guard*', '*/auth/admin*', '*/auth/optional-auth*', '*/auth/current-user*',
                  '*/auth/auth.service*', '*/auth/auth.controller*', '*/auth/*.util*', '*/auth/*-token.repository*'],
        ...
        { group: ['*/account/account.service*', '*/account/account.controller*', '*/account/dto/*'],
          message: 'Import from src/account/index.ts barrel instead (see auth.service.ts for the one documented exception).' },
        { group: ['*/payments/payments.service*', '*/payments/payments.controller*'],
          message: 'Import from src/payments/index.ts barrel instead.' },
      ],
    }],
  },
};
